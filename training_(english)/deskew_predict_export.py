...
# ------------------------- CONFIGURATION --------------------------
MODEL_PATH = r"runs/detect/train5/weights/best.pt"  # your trained YOLO model
SOURCE_DIR = r"D:\projects\MULTILINGUAL_OCR\multilingual_doc_understanding\ovr_v2\docs"  # folder with tilted images
OUT_JSON_DIR = r"D:\projects\MULTILINGUAL_OCR\multilingual_doc_understanding\ovr_v2\stage1_submission_jsons"  # where JSONs will go
OUT_IMG_DIR = r"D:\projects\MULTILINGUAL_OCR\multilingual_doc_understanding\ovr_v2\deskewed_predicted_images"  # annotated deskewed images for verification
