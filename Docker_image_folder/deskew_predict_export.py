...
parser.add_argument("--out_json", required=True, help="Output JSON directory")
parser.add_argument("--out_img", required=True, help="Output annotated images directory")
args = parser.parse_args()

SOURCE_DIR = args.source
OUT_JSON_DIR = args.out_json
